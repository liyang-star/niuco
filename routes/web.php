...
//     });
    ...
    Route::get('api/user/kj', 'Api\LoginController@kj');
    ...
    Route::group(['prefix' => 'admin', 'middleware' => ['admin_auth']], function () {
        ...
        Route::get('/setting/index_setkline', 'Admin\SettingController@index_setkline');
        Route::post('/setting/setkline', 'Admin\SettingController@setkline');
