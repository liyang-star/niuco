    ...
    "4dcc": function(t, a, i) {
        ...
        var n = {
          ...
          , d = function() {
            ...
            }, [t._v(t._s(t.i18n.limitPrice))])], 1), 1 == t.buyType ? i("v-uni-view", {   //限价输入框部分
                staticClass: "mt-20"
            }, [i("v-uni-input", {
            ...
            i("v-uni-view", {
                ...
                i("v-uni-text", {
                staticClass: "d-block"
            }, [t._v(t._s(t.i18n.number + " ( USDT ) "))])], 1), 
            ...
            i("v-uni-view", {
                ...
                model: {
                    ...
                    //value: 0,
                    callback: function(a) {
                       // t.margin = parseFloat( a / t.price ).toFixed(4)
                        t.number = a
                       // t.percent = a/t.user_lever
                    },
                    expression: "number"
                }
            })], 1),
            ...
            //         callback: function(a) {
            //             //t.margin = parseFloat( a / t.price ).toFixed(4)
            //             //t.number = parseFloat( a / t.price ).toFixed(4)
            //             // t.percent = a/t.user_lever
            //         },
            //         expression: "total_usdt"
            //     }
            // })], 1),
            ...
            i("u-slider", {
                ...
                model: {
                    ...
                    callback: function(a) {
                        t.percent = a,
                        t.number = parseFloat(t.user_lever * a / 100)
                    },
                    expression: "percent"
                }
            }, [i("v-uni-view", {}, [i("v-uni-view", {
                ...
                staticClass: "d-block",
                style:"position: absolute;top: 60%;left: 100%;color: #28ba98;",
            }, [t._v("" + t._s(t.percent) + "%" )]), 
            i("v-uni-text"), 
            i("v-uni-text")], 1)], 1)], 1)], 1), 
            ...
            i("v-uni-view", {
                ...
                staticClass: "d-block"
            }, [t._v(t._s(t.i18n.margin))]), i("v-uni-text", [t._v(t._s(t.margin))])], 1),
            
            i("v-uni-view", {
                staticClass: "mt-12 d-flex-between-center"
            }, [i("v-uni-text", {
                staticClass: "d-block"
            }, [t._v(t._s(t.i18n.handlingFee))]), i("v-uni-text", [t._v(t._s(t.handlingFee) + "USDT")])], 1),
            ...
            i("v-uni-view", {
                ...
                staticClass: "d-flex align-items-center"
            }, [i("v-uni-text", [t._v(t._s(t.user_lever) + "USDT")])], 1)], 1), 
                ...
                methods: {
                    ...
                    calc_old: function() {
                        var t = this.symbolQuotation
                          ...
                          , m = 0;
                        m = 0 == a ? parseFloat(e + p) : parseFloat(e - p);   //单价含差额
                     //   var g = parseFloat(m * o * n);  //总的市值

                     //   var total_num = parseFloat(n / m); //总的货币数量
                        var total_price = parseFloat( n * i); 

                        this.handlingFee = parseFloat(n * r / 100).toFixed(4),
                        this.margin = total_price - parseFloat(total_price * r / 100).toFixed(4)
                    ...
                    calc: function() {
                        ...
                        this.margin = n / e * i,
                        this.handlingFee = parseFloat(m * o * n / e * r / 100).toFixed(4)
                    }
                },
                computed: {
                    i18n: function() {
