...
//                var_dump($number);die;
            ...
            AccountLog::insertLog([
                ...
                'value' => -$number,
                'currency' => $usdt_id,
                'info' => AccountLog::getTypeInfo(AccountLog::WALLET_LEVEL_LEGAL_OUT),//合约转法币审核通过,合约减少
            ...
            AccountLog::insertLog([
                ...
                'value' => $number,
                'currency' => $usdt_id,
                'info' => AccountLog::getTypeInfo(AccountLog::WALLET_LEVEL_LEGAL_IN),//合约转法币审核通过，法币增加
